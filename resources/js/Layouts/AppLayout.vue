                                ...
                                <jet-dropdown align="center" width="48">
                                    ...
                                    <template #content>
                                        <div v-for="category in categories" :key="category.id">
                                            <jet-dropdown-link :href="route('category.index', category.slug)">
                                                {{ category.name }}
                                            </jet-dropdown-link>
                                        </div>
                                    </template>
                        ...
                        <div class="ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <jet-dropdown-link :href="route('dashboard', $page.user)">
                                        Dashboard
                                    </jet-dropdown-link>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        <jet-responsive-nav-link :href="route('dashboard', $page.user)" :active="route().current('dashboard')">
                            Dashboard
                        </jet-responsive-nav-link>
